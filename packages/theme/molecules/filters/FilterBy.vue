...
<template>
  <div class="flex items-center mb-4 text-blue-900">
    <label for="filter-options-menu" class="mr-3" @click="toggle()">{{ label }}</label>
    ...
    <div class="flex items-stretch">
      <div class="relative w-28 border rounded">
        ...
        >
          <div id="filter-options-menu" role="menu" aria-orientation="vertical" aria-labelledby="filter-options-menu">
            <button
